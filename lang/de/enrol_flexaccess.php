...
$string['mode:allowmagiclogin'] = 'E-Mail-Link';
...
$string['setting:allowmagiclogin'] = 'Standard: E-Mail-Link-Login erlauben';
$string['setting:allowmagiclogin_desc'] = 'Systemweite Obergrenze für den E-Mail-Link-Login (Magic). Instanzen können dies nur einschränken.';
