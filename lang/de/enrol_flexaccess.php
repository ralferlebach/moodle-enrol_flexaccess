...
$string['readiness'] = 'FlexAccess-Bereitschaft';
$string['readiness_authdisabled'] = 'Auth deaktiviert';
$string['readiness_enroldisabled'] = 'Einschreibe-Plugin deaktiviert';
$string['readiness_policy'] = 'Policy blockiert eine konfigurierte Methode';
$string['readiness_rolemodel'] = 'Rolle fehlerhaft';
$string['readinessincomplete'] = 'FlexAccess unvollständig: {$a}';
$string['readinesslink'] = 'FlexAccess-Systemstatus öffnen';
$string['readinessok'] = 'FlexAccess bereit';
