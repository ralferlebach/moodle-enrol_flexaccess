...
$string['access:enter'] = 'Enter course';
$string['access:enterintro'] = 'This course uses FlexAccess. Enter it with your existing account:';
...
$string['check:coupling'] = 'FlexAccess auth/enrol coupling';
$string['check:coupling:action'] = 'Manage enrol plugins';
$string['check:coupling:authonly'] = 'auth_flexaccess is enabled but enrol_flexaccess is not';
$string['check:coupling:authonly_detail'] = 'The authentication plugin is on, but no course can offer FlexAccess entry because the enrolment plugin is disabled. Enable enrol_flexaccess, or disable auth_flexaccess if FlexAccess is not in use.';
$string['check:coupling:bothoff'] = 'FlexAccess is not enabled.';
$string['check:coupling:enrolonly'] = 'enrol_flexaccess is enabled but auth_flexaccess is not';
$string['check:coupling:enrolonly_detail'] = 'The enrolment plugin provisions temporary and quick-registered accounts that authenticate through auth_flexaccess. With that authentication plugin disabled, those accounts cannot log in. Enable auth_flexaccess.';
$string['check:coupling:ok'] = 'auth_flexaccess and enrol_flexaccess are both enabled.';
...
$string['mode:allowguest'] = 'guest';
$string['mode:allowmagiclogin'] = 'email link';
$string['mode:allownormallogin'] = 'login';
$string['mode:allowquick'] = 'quick registration';
$string['mode:allowtemporary'] = 'temporary';
$string['mode:label'] = 'Active access modes';
$string['mode:none'] = 'no anonymous access';
...
$string['setting:allowguest'] = 'Default: allow normal guest access';
$string['setting:allowguest_desc'] = 'System default ceiling for Moodle guest access as a FlexAccess entry option. Instances may narrow this.';
$string['setting:allowmagiclogin'] = 'Default: allow email-link login';
$string['setting:allowmagiclogin_desc'] = 'System-wide ceiling for offering the email-link (magic) login. Instances may only narrow this.';
$string['setting:allownormallogin'] = 'Default: allow normal login';
$string['setting:allownormallogin_desc'] = 'System default ceiling for keeping the standard Moodle login available alongside FlexAccess methods.';
$string['setting:allowquick'] = 'Default: allow quick registration';
$string['setting:allowquick_desc'] = 'System default ceiling for quick registration. Must be on here (or widening enabled) for an instance checkbox to take effect.';
$string['setting:allowtemporary'] = 'Default: allow temporary users';
$string['setting:allowtemporary_desc'] = 'System default ceiling for temporary anonymous access. Must be on here (or widening enabled) for an instance checkbox to take effect.';
