...
$string['readiness'] = 'FlexAccess readiness';
$string['readiness_authdisabled'] = 'authentication plugin disabled';
$string['readiness_enroldisabled'] = 'enrolment plugin disabled';
$string['readiness_policy'] = 'policy blocks a configured method';
$string['readiness_rolemodel'] = 'roles faulty';
$string['readinessincomplete'] = 'FlexAccess incomplete: {$a}';
$string['readinesslink'] = 'Open FlexAccess system status';
$string['readinessok'] = 'FlexAccess ready';
