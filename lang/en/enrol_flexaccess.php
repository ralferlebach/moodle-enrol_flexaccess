...
$string['participantvisibility'] = 'Participant list visibility';
$string['participantvisibility:inherit'] = 'Inherit site default';
$string['participantvisibility_help'] = 'Whether temporary and quick-registered visitors of this course may view the course participant list. "Hide" prevents them from opening the participants page; "Inherit" uses the site default.';
